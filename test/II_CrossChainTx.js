...
it("Mike sends Drex Tx | Alice confirms Tx in Alien Chain | \
    ...
    const drexToken = drexTokenFactory.attach('0x208b1044FaA961085514869261405064370c00f2'); // everyone has Drex Token in Sepolia
    ...
    */
    ...
    const alienToken = alienTokenFactory.attach('0x44dF64Fb93f89555c2CA1E4FD3934a4a1535C9dC');
    console.log ('#######################');
  ...
  const merkleContract = merkleFactory.attach('0xACD2ca52556B537f3CbbC0E91E1C937ee6881288');
  ...
  const Listrack = factoryListrack.attach('0x6B2669c0CeD21817FEE720e937F2f230f966c4B0');
  console.log ('#######################');
  ...
  const alienListrack = factoryAlienListrack.attach('0x5D24C726ce6062AfbC32AceeaF66D525f44354dB');                                    
  console.log ('#######################');
